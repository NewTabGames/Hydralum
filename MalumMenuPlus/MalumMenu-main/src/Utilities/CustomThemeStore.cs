...
// the install, so the folder is the same for MalumMenu and Hydra — a theme saved in one menu shows up
// in the other. Each theme is a .txt whose contents are the color value: "#RRGGBB" or
// "grad:#AAAAAA,#BBBBBB" (the same format menuHtmlColor / Hydra's ThemeColor already use).
