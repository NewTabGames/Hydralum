...
namespace HydraMenu.features
{
	internal class Roles : MonoBehaviour
	{
		...
		public void Update()
		{
			...
			if(SkipSabotageChecks.SabotageAsCrewmate && HudManager.Instance.SabotageButton != null) HudManager.Instance.SabotageButton.gameObject.SetActive(true);
			if(AllowVentingForCrewmates && HudManager.Instance.ImpostorVentButton != null) HudManager.Instance.ImpostorVentButton.gameObject.SetActive(true);
		}
